...
// ../.wrangler/tmp/bundle-qtopm2/checked-fetch.js
...
async function createCookie(secret) {
  const token = await new SignJWT({}).setProtectedHeader({ alg: "HS256" }).setExpirationTime(`${maxAge}s`).sign(new TextEncoder().encode(secret));
...
// ../.wrangler/tmp/pages-QSmP8l/functionsRoutes-0.3130861676687011.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-qtopm2/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-qtopm2/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7992527850127871.mjs.map
